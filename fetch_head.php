...
<body>
	...
	<h1>
		...
		?> </h1>
<a href="https://ipsoft-amelia-demodeveu-v3.ipsoft.com/Amelia/ui/TheBankExperience/chat?embed=iframe&domainCode=sweden&processName=CreditCardProcessing&username=
<?php
if (isset($_GET['username'])) {
 echo $_GET['username'];
} else {
